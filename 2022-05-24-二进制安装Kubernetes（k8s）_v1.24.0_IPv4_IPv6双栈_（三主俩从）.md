...
layout: post
cid: 222
title: 二进制安装Kubernetes（k8s） v1.24.0 IPv4/IPv6双栈 （三主俩从）
slug: 222
date: 2022/05/24 16:13:00
updated: 2022/05/24 16:13:59
status: publish
author: cby
categories: 
  - 默认分类
tags: 
abstract: 
description: 二进制安装Kubernetes（k8s） v1.24.0 IPv4/IPv6双栈 （三主俩从）
