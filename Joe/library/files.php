  ...
  ?>
    ...
    <html<?php echo ' class="menu-' . ($menu_enabled ? 'enabled' : 'disabled sidebar-closed') . '"'; ?>>
      ...
      <head>
        ...
        <link rel="stylesheet" href="https://www.oiox.cn/static/photoswipe.css">
        <link href="<?php echo config::$assets ?>css/files.css" rel="stylesheet">
        <?php custom_script('css'); ?>
      </head>
      ...
      <body class="body-loading">
        ...
        <!-- Javascript -->
        <script src="https://www.oiox.cn/static/anime.min.js"></script>
        <script src="https://www.oiox.cn/static/list.min.js"></script>
        <script src="https://www.oiox.cn/static/yall.min.js"></script>
        <script src="https://www.oiox.cn/static/filesize.min.js"></script>
        <script src="https://www.oiox.cn/static/photoswipe.js"></script>
        <script src="https://www.oiox.cn/static/screenfull.min.js"></script>
        <script src="https://www.oiox.cn/static/dayjs.min.js"></script>
        <script src="https://www.oiox.cn/static/localizedFormat.js"></script>
        <script src="https://www.oiox.cn/static/relativeTime.js"></script>
        <script src="https://www.oiox.cn/static/bootstrap.min.js"></script>
        <script>
          var _c = <?php echo json_encode($json_config, JSON_PRETTY_PRINT); ?>;
          var CodeMirror = {};
        </script>
        <script src="https://www.oiox.cn/static/meta.js"></script>
        <!-- custom -->
