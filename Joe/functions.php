...
?>
    ...
    $JLive2d = new Typecho_Widget_Helper_Form_Element_Select(
        ...
        array(
            'off' => '关闭（默认）',
            'https://www.oiox.cn/static/shizuku.model.json' => 'shizuku',
            'https://www.oiox.cn/static/izumi.model.json' => 'izumi',
            'https://www.oiox.cn/static/haru01.model.json' => 'haru01',
            'https://www.oiox.cn/static/haru02.model.json' => 'haru02',
            'https://www.oiox.cn/static/wanko.model.json' => 'wanko',
            'https://www.oiox.cn/static/hijiki.model.json' => 'hijiki',
            'https://www.oiox.cn/static/koharu.model.json' => 'koharu',
            'https://www.oiox.cn/static/z16.model.json' => 'z16',
            'https://www.oiox.cn/static/haruto.model.json' => 'haruto',
            'https://www.oiox.cn/static/tororo.model.json' => 'tororo',
            'https://www.oiox.cn/static/chitose.model.json' => 'chitose',
            'https://www.oiox.cn/static/miku.model.json' => 'miku',
            'https://www.oiox.cn/static/Epsilon2.1.model.json' => 'Epsilon2.1',
            'https://www.oiox.cn/static/unitychan.model.json' => 'unitychan',
            'https://www.oiox.cn/static/nico.model.json' => 'nico',
            'https://www.oiox.cn/static/rem.model.json' => 'rem',
            'https://www.oiox.cn/static/nito.model.json' => 'nito',
            'https://www.oiox.cn/static/nipsilon.model.json' => 'nipsilon',
            'https://www.oiox.cn/static/ni-j.model.json' => 'ni-j',
            'https://www.oiox.cn/static/nietzche.model.json' => 'nietzche',
            'https://www.oiox.cn/static/platelet.model.json' => 'platelet',
            'https://www.oiox.cn/static/model.json' => 'isuzu',
            'https://www.oiox.cn/static/katou_01.model.json' => 'katou_01',
            'https://www.oiox.cn/static/mikoto.model.json' => 'mikoto',
            'https://www.oiox.cn/static/seifuku.model.json' => 'seifuku',
            'https://www.oiox.cn/static/ichigo.model.json' => 'ichigo',
            'https://www.oiox.cn/static/hk416.model.json' => 'hk416'
        ),
        'off',
    ...
    $JAside_Author_Image = new Typecho_Widget_Helper_Form_Element_Textarea(
        'JAside_Author_Image',
        NULL,
        "https://www.oiox.cn/static/aside_author_image.jpg",
        '博主栏背景壁纸 - PC',
    ...
    $JAside_Wap_Image = new Typecho_Widget_Helper_Form_Element_Textarea(
        'JAside_Wap_Image',
        NULL,
        "https://www.oiox.cn/static/wap_aside_image.jpg",
        '博主栏背景壁纸 - WAP',
    ...
    $JLazyload = new Typecho_Widget_Helper_Form_Element_Textarea(
        'JLazyload',
        NULL,
        "https://www.oiox.cn/static/lazyload.jpg",
        '自定义懒加载图',
        '介绍：用于修改主题默认懒加载图 <br/>
         格式：图片地址'
    );
    ...
    $JFriends = new Typecho_Widget_Helper_Form_Element_Textarea(
        'JFriends',
        NULL,
        'Joe的博客 || https://78.al || https://www.oiox.cn/static/link.png || Eternity is not a distance but a decision',
        '友情链接（非必填）',
        '介绍：用于填写友情链接 <br />
    ...
    $JPrismTheme = new Typecho_Widget_Helper_Form_Element_Select(
        'JPrismTheme',
        array(
            'https://www.oiox.cn/static/prism.min.css' => 'prism（默认）',
            'https://www.oiox.cn/static/prism-dark.min.css' => 'prism-dark',
            'https://www.oiox.cn/static/prism-okaidia.min.css' => 'prism-okaidia',
            'https://www.oiox.cn/static/prism-solarizedlight.min.css' => 'prism-solarizedlight',
            'https://www.oiox.cn/static/prism-tomorrow.min.css' => 'prism-tomorrow',
            'https://www.oiox.cn/static/prism-twilight.min.css' => 'prism-twilight',
            'https://www.oiox.cn/static/prism-a11y-dark.min.css' => 'prism-a11y-dark',
            'https://www.oiox.cn/static/prism-atom-dark.min.css' => 'prism-atom-dark',
            'https://www.oiox.cn/static/prism-base16-ateliersulphurpool.light.min.css' => 'prism-base16-ateliersulphurpool.light',
            'https://www.oiox.cn/static/prism-cb.min.css' => 'prism-cb',
            'https://www.oiox.cn/static/prism-coldark-cold.min.css' => 'prism-coldark-cold',
            'https://www.oiox.cn/static/prism-coldark-dark.min.css' => 'prism-coldark-dark',
            'https://www.oiox.cn/static/prism-darcula.min.css' => 'prism-darcula',
            'https://www.oiox.cn/static/prism-dracula.min.css' => 'prism-dracula',
            'https://www.oiox.cn/static/prism-duotone-dark.min.css' => 'prism-duotone-dark',
            'https://www.oiox.cn/static/prism-duotone-earth.min.css' => 'prism-duotone-earth',
            'https://www.oiox.cn/static/prism-duotone-forest.min.css' => 'prism-duotone-forest',
            'https://www.oiox.cn/static/prism-duotone-light.min.css' => 'prism-duotone-light',
            'https://www.oiox.cn/static/prism-duotone-sea.min.css' => 'prism-duotone-sea',
            'https://www.oiox.cn/static/prism-duotone-space.min.css' => 'prism-duotone-space',
            'https://www.oiox.cn/static/prism-ghcolors.min.css' => 'prism-ghcolors',
            'https://www.oiox.cn/static/prism-gruvbox-dark.min.css' => 'prism-gruvbox-dark',
            'https://www.oiox.cn/static/prism-hopscotch.min.css' => 'prism-hopscotch',
            'https://www.oiox.cn/static/prism-lucario.min.css' => 'prism-lucario',
            'https://www.oiox.cn/static/prism-material-dark.min.css' => 'prism-material-dark',
            'https://www.oiox.cn/static/prism-material-light.min.css' => 'prism-material-light',
            'https://www.oiox.cn/static/prism-material-oceanic.min.css' => 'prism-material-oceanic',
            'https://www.oiox.cn/static/prism-night-owl.min.css' => 'prism-night-owl',
            'https://www.oiox.cn/static/prism-nord.min.css' => 'prism-nord',
            'https://www.oiox.cn/static/prism-pojoaque.min.css' => 'prism-pojoaque',
            'https://www.oiox.cn/static/prism-shades-of-purple.min.css' => 'prism-shades-of-purple',
            'https://www.oiox.cn/static/prism-synthwave84.min.css' => 'prism-synthwave84',
            'https://www.oiox.cn/static/prism-vs.min.css' => 'prism-vs',
            'https://www.oiox.cn/static/prism-vsc-dark-plus.min.css' => 'prism-vsc-dark-plus',
            'https://www.oiox.cn/static/prism-xonokai.min.css' => 'prism-xonokai',
            'https://www.oiox.cn/static/prism-onelight.min.css' => 'prism-onelight',
            'https://www.oiox.cn/static/prism-onedark.min.css' => 'prism-onedark',
            'https://www.oiox.cn/static/prism-onedark.min.css.1' => 'prism-onedark2',
        ),
        'https://www.oiox.cn/static/prism.min.css',
        '选择一款您喜欢的代码高亮样式',
        '介绍：用于修改代码块的高亮风格 <br>
