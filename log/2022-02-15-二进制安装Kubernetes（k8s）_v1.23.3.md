...
layout: post
cid: 90
title: 二进制安装Kubernetes（k8s） v1.23.3
slug: 90
date: 2022/02/15 13:07:00
updated: 2022/02/23 16:57:56
status: publish
author: cby
categories: 
  - 默认分类
...
| 主机名称 | IP地址       | 说明       | 软件                                                         |
| -------- | ------------ | ---------- | ------------------------------------------------------------ |
| Master01 | 192.168.1.76    | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client |
| Master02 | 192.168.1.77    | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client |
| Master03 | 192.168.1.78    | master节点 | kube-apiserver、kube-controller-manager、kube-scheduler、etcd、<br />kubelet、kube-proxy、nfs-client |
| Node01   | 192.168.1.79    | node节点   | kubelet、kube-proxy、nfs-client                              |
| Node02   | 192.168.1.80    | node节点   | kubelet、kube-proxy、nfs-client                              |
| Lb01     | 192.168.1.86 | Lb01节点   | haproxy、keepalived                                          |
| Lb02     | 192.168.1.87 | Lb02节点   | haproxy、keepalived                                          |
|          | 192.168.1.88 | VIP        |                                                              |
|          |              |            |                                                              |
